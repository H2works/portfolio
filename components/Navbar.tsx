      ...
      <div className="col-auto ps-2 ms-2" id="navbarSupportedContent">
        <ul className="nav ms-auto mb-2 mb-lg-0 ms-2 list-inline list-unstyled">
          <li className="nav-item">
            <a className={`nav-link pe-3 ${darkMode ? 'link-light' : 'link-dark'} link-opacity-50-hover`} aria-label="Link to my Dribbble Portfolio" href="https://dribbble.com/Koenemann" target="_blank" rel="noopener noreferrer">
          ...
          <li className="nav-item">
            <a className={`nav-link pe-3 ${darkMode ? 'link-light' : 'link-dark'} link-opacity-50-hover`} href="https://www.behance.net/holgerkoenemann" aria-label="Link to my Behance Portfolio" target="_blank" rel="noopener noreferrer">
          ...
          <li className="nav-item">
            <a className={`nav-link ${darkMode ? 'link-light' : 'link-dark'} link-opacity-50-hover`} href="https://github.com/holger1411" aria-label="Link to my GitHub Profil Page" target="_blank" rel="noopener noreferrer">
